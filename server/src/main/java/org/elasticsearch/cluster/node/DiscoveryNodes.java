                ...
                if (nodeId.equals("_local")) {
                    ...
                    if (index != -1) {
                        ...
                        if (DiscoveryNode.Role.DATA.getRoleName().equals(matchAttrName)) {
                            ...
                            for (DiscoveryNode node : this) {
                                for (DiscoveryNode.Role role : Sets.difference(node.getRoles(), Set.of(DiscoveryNode.Role.MASTER, DiscoveryNode.Role.DATA))) {
                                    if (role.getRoleName().equals(matchAttrName)) {
                                        if (Booleans.parseBoolean(matchAttrValue, true)) {
                                            resolvedNodesIds.add(node.getId());
                                        } else {
